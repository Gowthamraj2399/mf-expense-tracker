...
const StatsCard = ({ title, value, change, changeType, icon, color }) => {
  ...
  return (
    <div className="flex flex-col gap-2 rounded-xl p-4 bg-white dark:bg-surface-dark border border-[#e5e7eb] dark:border-surface-highlight shadow-sm">
      ...
      <div>
        <p className="text-text-secondary text-xs font-medium mt-1">{title}</p>
